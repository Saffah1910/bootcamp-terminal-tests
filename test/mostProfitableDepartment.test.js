...
assert.equal('outdoor', mostProfitableDepartment(salesData), "Most profitable department is 'outdoor' for dataset 1");
    ...
    it('return the name of the deparartment from saleData2 which had the highest sales', function () {
        var salesData2 = [
     ...
     it('return no data found if an empty string was passed', function () {
         assert.equal("No data found", mostProfitableDepartment(""));
